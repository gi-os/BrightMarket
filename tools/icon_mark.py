#!/usr/bin/env python3
"""Build BrightMarket's launcher mark.
...
MARK = [
    ('M26,52 a7,7 0 0,0 14,0 a7,7 0 0,0 14,0 a7,7 0 0,0 14,0 a7,7 0 0,0 14,0 L74,30 L34,30 Z', 5, False),
    ('M34,52 V70', 5, False),
    ('M74,52 V70', 5, False),
    ('M45.00,60.00 H56.00 V69.00 H45.00 Z', 0, False),
    ('M61.50,65.00 A4.50,4.50 0 1 1 70.50,65.00 A4.50,4.50 0 1 1 61.50,65.00 Z', 0, False),
    ('M26.00,70.00 H82.00 V76.00 H26.00 Z', 0, False),
    ('M33,76 V86', 5, False),
    ('M75,76 V86', 5, False),
]
...
<!--
  BrightMarket launcher mark. One of the unified Bright* set: 108 canvas, 18..90
